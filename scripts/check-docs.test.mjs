...
test('checks sibling index, rules and document coverage when present', (t) => {
  ...
  write('../kassa/docs/README.md', '[architecture](architecture.md) [billing](billing.md) [backups](backups.md) [development](development.md)')
  write('../kassa/docs/architecture.md')
  write('../kassa/docs/billing.md')
  write('../kassa/docs/backups.md')
  write('../kassa/docs/development.md')
...
test('checks backup and development runbook links in the sibling repository', (t) => {
  const { root, write } = fixture(t)
  write('../kassa/README.md'); write('../kassa/AGENTS.md')
  write('../kassa/docs/README.md', '[billing](billing.md) [backups](backups.md) [development](development.md)')
  write('../kassa/docs/billing.md')
  write('../kassa/docs/backups.md', '[verifier](../scripts/missing-verify.sql)')
  write('../kassa/docs/development.md', '[runbook](missing-ops.md)')
  const errors = checkDocs({ root, requireKassa: true }).errors
  assert.equal(errors.length, 2)
  assert.match(errors.join('\n'), /backups\.md.*missing-verify/)
  assert.match(errors.join('\n'), /development\.md.*missing-ops/)
})
