...
export const ONLINE_BACKGROUND_PRESETS = [
  ...
  },
  {
    id: 'ivory',
    label: 'Ivory',
    preview: '/uploads/menu-backgrounds/ivory-food.jpg',
    value: `${SITE_ORIGIN}/uploads/menu-backgrounds/ivory-food.jpg`,
  },
  {
    id: 'sage',
    label: 'Sage',
    preview: '/uploads/menu-backgrounds/sage-food.jpg',
    value: `${SITE_ORIGIN}/uploads/menu-backgrounds/sage-food.jpg`,
  },
  {
    id: 'coral',
    label: 'Coral',
    preview: '/uploads/menu-backgrounds/coral-food.jpg',
    value: `${SITE_ORIGIN}/uploads/menu-backgrounds/coral-food.jpg`,
  },
  {
    id: 'midnight',
    label: 'Midnight',
    preview: '/uploads/menu-backgrounds/midnight-food.jpg',
    value: `${SITE_ORIGIN}/uploads/menu-backgrounds/midnight-food.jpg`,
  },
  {
    id: 'mustard',
    label: 'Mustard',
    preview: '/uploads/menu-backgrounds/mustard-food.jpg',
    value: `${SITE_ORIGIN}/uploads/menu-backgrounds/mustard-food.jpg`,
  },
]
