...
стенд фейковой оплаты реализованы в 166. На 13.09.2026 production обновлён
до схемы 167; провайдер не подключён, покупки выключены. Тестовый стенд
остаётся только локальным. Ручная выдача доступа
